...
(deftest test-target-1
  (TESTING "Single char replacement"
    (OK (equalp (str-algo::myers-distance  "A" "B")'((:DELETE 0 0) (:INSERT 1 0)))))
  (TESTING "Single deletion at end"
    (OK (equalp (str-algo::myers-distance "AB" "A")'((:DELETE 1 1)))))
  (TESTING "Single insertion at end"
    (OK (equalp (str-algo::myers-distance "A" "AB")'((:INSERT 1 1)))))
  (TESTING "Multiple replacements"
    (OK
     (equalp (str-algo::myers-distance "AAAA" "BBBB")
  ...
  (TESTING "Complex interleaved operations"
    (OK
     (equalp (str-algo::myers-distance "ABCABBA" "CBABAC")
